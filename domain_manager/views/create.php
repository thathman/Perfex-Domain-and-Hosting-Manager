                ...
                <div class="panel-body">
                        <div class="container-fluid">
                            ...
                            <div class="row">   
                                ...
                                <div class="col-md-6">
                                    <?php echo render_input('domain_manager_provider', _l('domain_manager_provider'), '', 'text', ['id' => 'domain_manager_provider', 'placeholder' =>  _l('domain_manager_provider'), 'autocomplete' => 'off']); ?>
                                </div>
                                <div class="col-md-6">
